...
// Defined via CMake generated marcos
    ...
    inline constexpr const char* kHostPackageName = V_TOSTR(INJECTED_PACKAGE_NAME);
    inline constexpr const char* kManagerPackageName = V_TOSTR(MANAGER_PACKAGE_NAME);
